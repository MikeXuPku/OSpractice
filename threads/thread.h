...
// Thread state
enum ThreadStatus { JUST_CREATED, RUNNING, READY, BLOCKED ,SUSPEND_READY,SUSPEND_BLOCKED};
static char* thread_status[6] = {"JUST_CREATED", "RUNNING", "READY", "BLOCKED","SUSPEND_READY","SUSPEND_BLOCKED"};
